...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default: "bg-gradient-primary text-primary-foreground shadow-professional hover:shadow-lg hover:scale-[1.02] active:scale-[0.98]",
        destructive:
        ...
        professional:
          "bg-gradient-secondary text-foreground border border-border shadow-sm hover:shadow-professional hover:scale-[1.01]",
        success:
        ...
        premium:
          "bg-gradient-hero text-primary-foreground shadow-professional hover:shadow-lg hover:scale-[1.02] active:scale-[0.98]",
      },
      size: {
